...
use SVGGraph\Axis\Axis;
use SVGGraph\Axis\AxisDateTime;
use SVGGraph\Axis\AxisFixed;
use SVGGraph\Axis\AxisLog;
...
abstract class GridGraph extends Graph
{
    ...
    protected function VLabel(&$attribs)
    {
        ...
        $text = '';
        $label = is_array($this->label_v) ? $this->label_v : [$this->label_v];
    ...
    protected function GridCrossHairs(&$grid_group)
    {
        ...
        $hch = ['class' => 'chX', 'x2' => $ch['x1'] + $this->g_width];
        ...
        // vertical hair
        $hch = ['class' => 'chY', 'y2' => $ch['y1'] + $this->g_height];
        ...
        $text_group = ['id' => $this->NewId(), 'visibility' => 'hidden'];
        $text_rect = [
            'x'      => $this->grid_,
            'y'      => 0,
            'width'  => '10',
